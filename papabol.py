...
def main():
    ...
    logo()
    print('-------------------------------------------')
    print("\033[1;34m Note >>  AM11T KI DIDI KA 3K LAUTA AASHIQ S9UR4V D9N")
    print('-------------------------------------------')
    coki = input(' [+] Cookies : ')
    cookies={'cookie': coki}
    ...
    if 'mbasic_logout_button' in ch.text:
        ...
        print(' \x1b[1;91AM11T ke didi ke gaand me cookies dal do 😹 !!! \x1b[1;97m')
        os.sys.exit()
    print(' \x1b[1;92m Account Logged in Successfully\x1b[1;97m ')
    print('-------------------------------------------')
    delay = int(input(' [+] AMIT KI DIDI KO JITNA SPEED ME CHODNA HA DAL DO : '))
    print('-------------------------------------------')
    lnk = input(' [+] AMIT KE DD KE BH9SD33 ME LINK DAL DO : ')
    print('-------------------------------------------')
    lim = int(input(' [+] AMIT KI GAAND ME  Repeat dal do : '))
    print('-------------------------------------------')
    hater = input(' [+] AMIT KE SARE BAAP KA NAAM DAL DO   : ')
    print('-------------------------------------------')
    filee = input(' [+] File : ')
    ...
    with bsn(max_workers=30) as crack:
        ...
        print("\033[1;34mAM11T KI DIDI KO NONSTOP CHODNE KE LIYE NET ON RAKHNA  😐")
        print('-------------------------------------------')
        for mess in idd:
            sm = '1'
            if sm == '1':
